  ...
  <VaContent class="typography content">
      ...
      <VaCard class="col-span-12">
        ...
        <VaCardContent>
          ...
          <div class="mb-8">
            ...
            <p>
              None has a greater influence on life on planet Earth than it’s own satellite, the
              moon. When you think about it.
            </p>
          </div>
          <div class="mb-8">
            <h3>Display 3 Heading</h3>
            <p>
              Let’s talk about meat fondue recipes and what you need to know first. Meat fondue also
              known as oil fondue is a method of cooking all kinds of meats, poultry, and seafood in
              a pot of heated oil.
            </p>
          </div>
          <div class="mb-8">
            ...
            <p>
              There is something about parenthood that gives us a sense of history and a deeply
              rooted desire to send on into the next generation the great things we have discovered
              about life.
            </p>
          </div>
          <div class="mb-8">
    ...
    &lt;/p></pre
            ...
            <p>
              Of all of the celestial bodies that capture our attention and fascination as
              astronomers,
              <span class="text--code">currentColor</span> none has a greater influence on life on
              planet Earth than it’s own satellite, the moon.
            </p>
          </div>
        </VaCardContent>
      </VaCard>
      ...
      <VaCard class="col-span-12">
        ...
        <VaCardContent>
          ...
          <ol class="va-ordered">
            <li>
              Of all of the celestial bodies that capture our attention and fascination as
              astronomers, none has a greater influence.
            </li>
          ...
          <div class="mb-8">
            ...
            <p>
              ...
              life on planet Earth than it’s own satellite, the selected chunk of text. When you
              think about it.
            </p>
          </div>
          <div class="mb-8">
            <blockquote class="va-blockquote border-primary">
              <p>
                BQ: Let’s talk about meat fondue recipes and what you need to know first. Meat
                fondue also known as oil fondue is a method of cooking all kinds.
              </p>
              <p>
                <i>— Mister Lebowski</i>
              </p>
          ...
          <div class="mb-8">
            <div class="text-block">
              ...
              <span
                >Of all of the celestial bodies that capture our attention and fascination as
                astronomers, none has a greater influence on life on planet Earth than it’s own
                satellite, the moon. When you think about it.</span
              >
            </div>
          </div>
          <div class="mb-8">
